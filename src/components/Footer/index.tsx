            ...
            <div className="pt-1 flex flex-col gap-3">
              ...
              <div className="flex items-center gap-3 pt-1">
                <a
                  ...
                  className="w-8 h-8 rounded-full bg-white/10 hover:bg-[#E91E8C] flex items-center justify-center text-white transition-all duration-200 hover:scale-110"
                >
                ...
                <a
                  ...
                  className="w-8 h-8 rounded-full bg-white/10 hover:bg-[#0088cc] flex items-center justify-center text-white transition-all duration-200 hover:scale-110"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
