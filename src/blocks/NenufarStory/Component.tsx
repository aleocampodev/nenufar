...
export const NenufarStoryBlock: React.FC<Props & { id?: string }> = ({
  ...
  return (
    <section
      id={id || 'historia'}
      className="py-20 md:py-28 bg-[#FAF8F5] border-y border-neutral-100 scroll-mt-24 overflow-hidden"
    >
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <ScrollReveal variant="fade-right" duration={900}>
            <div className="relative overflow-hidden rounded-3xl bg-neutral-100 aspect-[4/5] shadow-[0_10px_40px_rgba(0,0,0,0.06)] group">
              {hasImage ? (
                <PayloadMedia
          ...
          {/* Contenido Narrativo */}
          <ScrollReveal variant="fade-left" delay={150} duration={900}>
