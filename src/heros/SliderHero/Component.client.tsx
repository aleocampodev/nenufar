...
export const SliderHeroClient: React.FC<{
  ...
  return (
    ...
    >
      <div className="relative z-20 max-w-[1340px] mx-auto px-4 sm:px-6 lg:px-8 w-full pt-[clamp(3.5rem,calc(52vh-272px),14rem)] sm:pt-6 md:pt-8 lg:pt-8 pb-4 sm:pb-8 lg:my-auto">
