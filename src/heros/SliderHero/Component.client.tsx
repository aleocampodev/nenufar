      ...
      <div className="relative max-w-[1340px] mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 z-10 flex flex-col items-start text-left max-w-2xl">
            ...
            <div ref={chipsRef} className="flex flex-wrap items-center gap-2.5 sm:gap-3.5 mb-6 pt-1">
            ...
            <div
              ref={socialsRef}
              className="flex items-center gap-4 text-[#3D1A5B]/70 dark:text-white/70 pt-1"
              role="navigation"
              aria-label="Redes sociales de Nénufar"
            >
              <span className="text-xs uppercase tracking-[0.2em] font-sans font-medium text-[#3D1A5B]/50 dark:text-white/40 mr-1">
                Síguenos:
              </span>
              <a
                ...
                className="p-1.5 rounded-full hover:bg-white/90 dark:hover:bg-[#1A0E2E] hover:text-[#E91E8C] transition-all duration-200 hover:scale-120 cursor-pointer shadow-2xs"
              >
              ...
              <a
                ...
                className="p-1.5 rounded-full hover:bg-white/90 dark:hover:bg-[#1A0E2E] hover:text-[#25D366] transition-all duration-200 hover:scale-120 cursor-pointer shadow-2xs"
              >
              ...
              <a
                ...
                className="p-1.5 rounded-full hover:bg-white/90 dark:hover:bg-[#1A0E2E] hover:text-[#0088cc] transition-all duration-200 hover:scale-120 cursor-pointer shadow-2xs"
              >
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
