...
function buildSystemPrompt(): string {
  return [
    ...
    '- Si Shirley pide agendar un taller o feria, usa publicarEvento.',
    '- Si Shirley pide ver los talleres y ferias programados, usa listarEventos.',
    '- Si Shirley pide eliminar o cancelar un taller o feria, usa eliminarEvento.',
