...
function buildSystemPrompt(): string {
  return [
    ...
    '- Si Shirley pide cambiar, editar o actualizar el texto, título o descripción de cualquier sección de la landing (Nuestra Historia, Tradición y Delicadeza, Talleres y Ferias, o Contacto), usa actualizarTextoSeccion.',
