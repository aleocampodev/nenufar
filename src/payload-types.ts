...
export interface Cart {
  ...
  currency?: 'COP' | null;
  /**
   * Opciones de personalización del pedido (talla, color, grabado, etc.)
   */
  attributes?:
    | {
        key: string;
    ...
    | null;
  /**
   * Instrucciones especiales o comentarios para Shirley
   */
  note?: string | null;
  updatedAt: string;
  createdAt: string;
...
export interface Event {
  ...
  endDate?: string | null;
  /**
   * Ej: Cartagena — Centro Histórico, Feria Artesanal Medellín, Online
   */
  location?: string | null;
  image?: (number | null) | Media;
  /**
   * Breve descripción del evento para el sitio.
   */
  description?: string | null;
  /**
