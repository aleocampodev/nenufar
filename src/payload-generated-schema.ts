...
export const enum_carts_currency = pgEnum('enum_carts_currency', ['COP'])
...
export const enum_orders_currency = pgEnum('enum_orders_currency', ['COP'])
...
export const enum_transactions_currency = pgEnum('enum_transactions_currency', ['COP'])
...
export const _posts_v_rels = pgTable(
  ...
  (columns) => [
    ...
    index('_posts_v_rels_products_id_idx').on(columns.productsID),
    foreignKey({
      columns: [columns['parent']],
...
export const variants = pgTable(
  'variants',
  {
    ...
    priceInCOPEnabled: boolean('price_in_c_o_p_enabled'),
    priceInCOP: numeric('price_in_c_o_p', { mode: 'number' }),
    updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 })
      .defaultNow()
      .notNull(),
    createdAt: timestamp('created_at', { mode: 'string', withTimezone: true, precision: 3 })
...
export const _variants_v = pgTable(
  '_variants_v',
  {
    ...
    version_priceInCOPEnabled: boolean('version_price_in_c_o_p_enabled'),
    version_priceInCOP: numeric('version_price_in_c_o_p', { mode: 'number' }),
    version_updatedAt: timestamp('version_updated_at', {
      mode: 'string',
      withTimezone: true,
      precision: 3,
...
export const carts_attributes = pgTable(
  'carts_attributes',
  {
    _order: integer('_order').notNull(),
    _parentID: integer('_parent_id').notNull(),
  ...
  (columns) => [
    index('carts_attributes_order_idx').on(columns._order),
    index('carts_attributes_parent_id_idx').on(columns._parentID),
    foreignKey({
      columns: [columns['_parentID']],
      foreignColumns: [carts.id],
      name: 'carts_attributes_parent_id_fk',
    }).onDelete('cascade'),
  ],
)
...
export const carts = pgTable(
  'carts',
  {
    ...
    currency: enum_carts_currency('currency').default('COP'),
    note: varchar('note'),
    updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 })
      .defaultNow()
      .notNull(),
...
export const orders = pgTable(
  'orders',
  {
    ...
    currency: enum_orders_currency('currency').default('COP'),
  ...
  (columns) => [
    ...
    uniqueIndex('orders_access_token_idx').on(columns.accessToken),
...
export const transactions = pgTable(
  'transactions',
  {
    ...
    amount: numeric('amount', { mode: 'number' }),
    currency: enum_transactions_currency('currency').default('COP'),
    updatedAt: timestamp('updated_at', { mode: 'string', withTimezone: true, precision: 3 })
      .defaultNow()
      .notNull(),
    createdAt: timestamp('created_at', { mode: 'string', withTimezone: true, precision: 3 })
...
export const relations_carts_attributes = relations(carts_attributes, ({ one }) => ({
  _parentID: one(carts, {
    fields: [carts_attributes._parentID],
    references: [carts.id],
...
export const relations_carts = relations(carts, ({ one, many }) => ({
  ...
  attributes: many(carts_attributes, {
    relationName: 'attributes',
  }),
}))
...
type DatabaseSchema = {
  ...
  carts_attributes: typeof carts_attributes
  carts: typeof carts
  ...
  relations_carts_attributes: typeof relations_carts_attributes
