...
export function ShopCategoriesSection() {
  return (
    <section style={{ display: "flex", width: "100%", height: "500px" }}>
      {categories.map((cat) => (
        <div
          key={cat.label}
